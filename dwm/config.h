...
static const char *browcmd[]  = { "brave-browser-stable", NULL };
...
/* bar-dmenu */
static const char *statuscmd[] = { "/home/void/.user/bar_dmenu", NULL };
